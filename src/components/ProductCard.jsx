  ...
  return (
    <Link to={`/product/${product.id}`} className="group cursor-pointer">
      ...
      <div className="relative overflow-hidden bg-parchment aspect-[3/4] mb-5">
        ...
        {/* Tag */}
        {product.tag && (
          <div className="absolute top-4 left-4 bg-white text-[#003314] text-[9px] tracking-[0.3em] uppercase px-3 py-1.5">
            {product.tag}
          </div>
        )}
        {/* Quick view overlay */}
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="text-right">
          <p className="font-serif text-sm text-charcoal" style={{ fontFamily: "poppins" }}>
            {product.price}
          </p>
        </div>
      </div>
